                ...
                releases: [
                    {
                        ...
                        title: "Summer Update",
                        summary:
                            "A major content update introducing new emergency service features, UI improvements, performance optimizations, and quality-of-life fixes.",
                        author: "Scuffed Labs",
                        important: true,
                        ...
                        sections: [
                            {
                                ...
                                entries: [
                                    {
                                        category: "Police",
                                        text: "Added evidence lockers to every police station.",
                                    },
                                    {
                                        category: "Police",
                                        text: "Added department armories with configurable loadouts.",
                                    },
                                    {
                                        category: "EMS",
                                        text: "Added stretcher interactions and hospital check-in.",
                                    },
                                    {
                                        category: "Vehicles",
                                        text: "Added five new civilian vehicles.",
                                    },
                                    {
                                        category: "UI",
                                        text: "Added a redesigned dispatch interface.",
                                    },
                                ],
                            },
                            {
                                ...
                                entries: [
                                    {
                                        category: "Economy",
                                        text: "Increased taxi payouts by 15%.",
                                    },
                                    {
                                        category: "UI",
                                        text: "Improved the inventory layout and responsiveness.",
                                    },
                                    {
                                        category: "General",
                                        text: "Reduced overall loading times.",
                                    },
                                ],
                            },
                            {
                                ...
                                entries: [
                                    {
                                        category: "Police",
                                        text: "Fixed officers occasionally losing duty status after reconnecting.",
                                    },
                                    {
                                        category: "Economy",
                                        text: "Fixed duplicate paychecks.",
                                    },
                                    {
                                        category: "Performance",
                                        text: "Reduced network usage during peak player counts.",
                                    },
                                ],
                            },
                            {
                                ...
                                entries: [
                                    {
                                        category: "General",
                                        text: "Improved server-side validation for sensitive events.",
                                    },
                                ],
                            },
                        ],
                    },
                    {
                        ...
                        summary: "A focused update for Police and EMS gameplay.",
                        author: "Scuffed Labs",
                        important: false,

                        categories: ["Police", "EMS"],
                        ...
                        sections: [
                            {
                                ...
                                entries: [
                                    {
                                        category: "Police",
                                        text: "Added fingerprint evidence.",
                                    },
                                    {
                                        category: "EMS",
                                        text: "Added patient transportation.",
                                    },
                                ],
                            },
                            {
                            ...
                            },
                            {
                                ...
                                entries: [
                                    {
                                        category: "EMS",
                                        text: "Fixed hospital respawn issues.",
                                    },
                                ],
                            },
                        ],
                    },
                    {
                        ...
                        summary:
                            "A large optimization pass focused on improving client performance.",
                        author: "Scuffed Labs",
                        important: false,
                        ...
                        sections: [
                            {
                                ...
                                entries: [
                                    {
                                        category: "Performance",
                                        text: "Optimized entity streaming.",
                                    },
                                    {
                                        category: "Performance",
                                        text: "Reduced client memory usage.",
                                    },
                                ],
                            },
                            {
                                ...
                                entries: [
                                    {
                                        category: "General",
                                        text: "Fixed several UI scaling issues.",
                                    },
                                ],
                            },
                        ],
...
function getInitialVersion(
    ...
    if (
        requested &&
        data.releases.some((release) => release.version === requested)
    )
        return requested;
...
function getReleaseCategories(release: Release): string[] {
    return [
        "All",
        ...release.categories.filter((category) => category !== "All"),
    ];
}
...
export function App() {
    ...
    useNuiEvent<OpenPayload>(
        ...
        useCallback((payload) => {
            if (!payload) {
                console.error("Missing changelog payload");
                return;
            }

            if (!isChangelogData(payload.data)) {
                console.error("Invalid changelog data", payload.data);
                return;
            }
    ...
    const release = useMemo(
        () =>
            data?.releases.find((item) => item.version === version) ??
            data?.releases[0],
        [data, version],
    );
    ...
    const handleAnimationEnd = useCallback(
        (event: AnimationEvent<HTMLElement>) => {
            if (event.target !== event.currentTarget || visibility !== "closing")
                return;

            setData(null);
            setVersion("");
            setCategory("All");
            void fetchNui<{ ok: boolean }>("close", {}, { ok: true }).catch(
                () => undefined,
            );
        },
        [visibility],
                ...
                <div className="flex min-w-0 flex-1 flex-col">
                    ...
                    <div className="border-b px-7 py-3.5 max-[680px]:px-4">
                        <div className="flex flex-wrap gap-2">
                            ...
                            {release.author && (
                                <Metadata icon={IconUser}>{release.author}</Metadata>
                            )}
                            {release.important && (
                                            ...
                                            <ul className="mt-3 grid gap-2.5">
                                                {section.entries.map((entry, index) => (
                                                    <li
                                                        ...
                                                        className="flex gap-2.5 text-xs leading-6"
                                                    >
                                                        <span className="mt-2.5 size-1.5 shrink-0 rounded-full bg-primary" />
                                                        <span>
                                                            <span className="mr-2 inline-flex rounded border bg-secondary px-1 py-0.5 font-mono text-xs text-muted-foreground uppercase">
                                                                {entry.category}
                                                            </span>
                                                            {entry.text}
                                                        </span>
                    ...
                    <footer className="flex justify-between border-t px-7 py-2.5 text-[0.67rem] text-muted-foreground max-[680px]:px-4">
                        <span className="hidden text-xs text-muted-foreground sm:block">Press <kbd className="rounded border border-border bg-background px-1.5 py-0.5 font-mono">ESC</kbd> to close</span>
